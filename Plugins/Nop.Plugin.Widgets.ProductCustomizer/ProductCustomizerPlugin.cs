...
namespace Nop.Plugin.Widgets.NivoSlider
{
    ...
    /// PLugin
    /// </summary>
    public class ProductCustomizerPlugin : BasePlugin, IWidgetPlugin
    {
        ...
        public override void Install()
        {
            ...
            //settings
            var settings = new ProductCustomizerSettings()
            {
        ...
        {
            //settings
            _settingService.DeleteSetting<ProductCustomizerSettings>();
